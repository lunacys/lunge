...
public class SteeringBehaviorsComponent : Component//RenderableComponent/*, IUpdatable*/
{
    ...
    [Inspectable] public PathFollowingMode PathFollowingMode = PathFollowingMode.OneWay;
    ...
    public override void Initialize()
    {
        ...
        _defaultTexture = Core.Content.LoadTexture(Content.Steering.YellowArrow, true);
        _obstacleTexture = Core.Content.LoadTexture(Content.Steering.GreenSquare, true);
    ...
    {
        if (Input.LeftMouseButtonPressed && Input.MousePosition.X >= 0 && Input.MousePosition.Y >= 0)
        {
    ...
    public void UiLayout()
    {
        ...
        ImGui.Text($"Mouse Pos: {Input.MousePosition}, Raw: {Input.RawMousePosition}, Scaled: {Input.ScaledMousePosition}");
