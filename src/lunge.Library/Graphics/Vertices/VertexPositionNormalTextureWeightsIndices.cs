...
{
    public struct VertexPositionNormalTextureWeightsIndices : IVertexType
    {
        ...
        public VertexPositionNormalTextureWeightsIndices(Vector3 position, Vector3 normal, Vector2 textureCoordinate, Vector4 blendWeights, Byte4 blendIndices)
        {
