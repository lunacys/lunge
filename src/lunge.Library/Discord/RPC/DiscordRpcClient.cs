using System;
using lunge.Library.Discord.RPC.Exceptions;
using lunge.Library.Discord.RPC.IO;
using lunge.Library.Discord.RPC.Logging;
using lunge.Library.Discord.RPC.Message;
using lunge.Library.Discord.RPC.RPC;
using lunge.Library.Discord.RPC.RPC.Commands;

namespace lunge.Library.Discord.RPC
{
	/// <summary>
